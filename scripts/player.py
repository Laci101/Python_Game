...
class Player(Entity):
    def __init__(self,pos,groups,obstacle_sprites,create_attack,destroy_attack,create_magic):
        ...
        self.stats = {'health': 100, 'energy': 50, 'attack': 5, 'magic': 1, 'speed': 4}
        self.max_stats = {'health': 200, 'energy': 100, 'attack': 15, 'magic': 5, 'speed': 8}
    ...
    def input(self):
        if not self.attacking:
            ...
            if keys[pygame.K_e] and self.can_switch_weapon:
                ...
                elif self.weapon_index < len(list(weapon_data.keys())):
                    self.weapon_index -= 1
            ...
            if keys[pygame.K_2] and self.can_switch_magic:
                ...
                elif self.magic_index < len(list(magic_data.keys())):
                    self.magic_index -= 1
    ...
    def import_player_assets(self):
        character_path = "graphics/my_tilesets/player/"
